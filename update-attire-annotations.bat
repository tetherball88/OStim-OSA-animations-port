...
set "DONOR_MAIN_DIR=..\OSexAttire AE"
set /p DONOR_MAIN_DIR=Enter path to OSA Attire animation pack main folder [Default: !DONOR_MAIN_DIR!]: 
if "!DONOR_MAIN_DIR!"=="" set "DONOR_MAIN_DIR=..\OSexAttire AE"
set "DONOR_ANIM_DIR=!DONOR_MAIN_DIR!\meshes\0SA\mod\0Sex\anim\attire"
...
REM Set path to annotations-attire.json in the same folder as this script
set "ANNOTATION_JSON=%~dp0annotations-attire.json"
