...
set "DONOR_ANIM_DIR=..\OSexAttire AE\meshes\0SA\mod\0Sex\anim\attire"
set /p DONOR_ANIM_DIR=Enter full path to donor animation directory [Default: !DONOR_ANIM_DIR!]: 
if "!DONOR_ANIM_DIR!"=="" set "DONOR_ANIM_DIR=..\OSexAttire AE\meshes\0SA\mod\0Sex\anim\attire"
...
REM Set path to annotations.json in the same folder as this script
set "ANNOTATION_JSON=%~dp0annotations.json"
